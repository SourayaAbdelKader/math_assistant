...
const QuestionSubHeader = () => {
    ...
    return(
        <div className="sub_header_container">
            ...
            <div> <h4 className="shadow unerline bold hover-underline-animation" onClick={navigateQuestions}> Questions </h4> </div>
            <div> <h4 className="shadow hover-underline-animation" onClick={navigatePractice}> Practice </h4> </div>
        </div>   
    )
}
