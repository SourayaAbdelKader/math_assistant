...
const LoginWidget = () => {
    ...
    const navigaSignup= () => {navigate('/signup');};
    ...
    return(
        <div className="login_card">
            ...
            <div className="space"> 
                ...
                <p className="pointer register p" onClick={navigaSignup}> Register </p>
            </div>
            <div> <button className="button" type="submit" onClick={onSubmit}> Login </button>  </div>
        </div>
    )
}
