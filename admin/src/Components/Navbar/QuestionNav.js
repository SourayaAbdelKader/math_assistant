...
import questions from '../../images/dash_questions_selected.png';
...
const QuestionNav = () => {
    ...
    return(
        <div className="nav_container">
            ...
            <div onClick={navigateQuestions} className="flex choosen part cursor">
                <div> <img className="icon" src={questions} alt="" /> </div>
                <div className="bold white_text"> Questions </div>
            </div>
